    ...
    () => [
      {
        ...
        location: "Japan",
        description:
          "Discover the wonders of Japan through this comprehensive travel guide. From ancient temples to modern cities, experience the perfect blend of tradition and innovation that makes Japan unique.",
      },
      {
        ...
        location: "Japan",
        description:
          "Immerse yourself in the breathtaking natural landscapes of Japan. From snow-capped mountains to serene countryside, witness the stunning beauty that defines this incredible destination.",
      },
      {
        ...
        location: "Japan",
        description:
          "Experience the rich cultural heritage and timeless traditions of Japan. From traditional ceremonies to historic landmarks, explore the cultural treasures that have shaped this fascinating nation.",
      },
    ],
    []
  );
