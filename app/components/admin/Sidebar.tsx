...
export default function Sidebar() {
  ...
  return (
    <div className="hidden lg:flex fixed left-0 top-0 min-h-screen w-64 flex-col bg-slate-950 dark:bg-gray-900 text-white border-r border-white/10 dark:border-gray-700 shadow-xl lg:w-72">
      <div className="p-6 border-b border-white/10">
        <p className="text-xs uppercase tracking-[0.3em] text-slate-400 dark:text-gray-500">
          Admin
        </p>
        <h1 className="text-2xl font-semibold text-white dark:text-gray-100 mt-2">
          Gography
        </h1>
            ...
            >
              <span
                className={`flex h-10 w-10 items-center justify-center rounded-xl border border-white/10 dark:border-gray-700 bg-white/5 dark:bg-gray-800/30 text-lg ${
                  active
                    ? "border-white/30 dark:border-orange-400/50 bg-white/20 dark:bg-orange-600/20"
                    : ""
                }`}
              >
                <item.Icon />
