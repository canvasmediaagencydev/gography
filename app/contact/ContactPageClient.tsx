      ...
      <div className="min-h-screen bg-white">
        ...
        <section className="py-12 px-6 bg-white">
          <div className="container mx-auto max-w-6xl">
            <div className="bg-white rounded-2xl shadow-2xl -mt-24 relative z-20 p-8">
              <div className="grid grid-cols-2 md:grid-cols-5 gap-6">
                ...
                >
                  ...
                  <span className="text-sm font-semibold text-gray-700">@Gography</span>
                </a>
                ...
                <a
                  ...
                  className="flex flex-col items-center gap-3 p-4 rounded-xl hover:bg-gray-50 transition-colors group"
                >
                  <div className="w-16 h-16 bg-gradient-to-br from-purple-600 via-pink-600 to-orange-500 rounded-full flex items-center justify-center group-hover:scale-110 transition-transform">
                    <svg className="w-8 h-8 text-white" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div className="container mx-auto max-w-6xl">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="bg-white rounded-2xl shadow-lg p-8 border border-gray-100">
                <h3 className="text-2xl font-bold text-gray-900 mb-4">ช่องทางการติดต่อ</h3>
                <p className="text-gray-600 mb-4">วันจันทร์-ศุกร์ 10:00-18:00</p>
                <a
              ...
              <div className="bg-white rounded-2xl shadow-lg p-8 border border-gray-100">
                ...
                <div className="flex items-start gap-3 text-gray-700">
                  <svg className="w-6 h-6 text-orange-600 flex-shrink-0 mt-1" fill="currentColor" viewBox="0 0 20 20">
          ...
          <div className="container mx-auto max-w-4xl">
            ...
            <div className="bg-white rounded-2xl shadow-2xl p-8 md:p-12">
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <button
                  type="submit"
                  className="w-full bg-orange-600 hover:bg-orange-700 text-white font-bold py-4 rounded-full transition-all duration-300 hover:scale-105 shadow-lg text-lg"
                >
