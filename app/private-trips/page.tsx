...
const benefits = [
  ...
  },
  {
    ...
    description: 'ยืดหยุ่นเรื่องเวลาและกิจกรรมได้เต็มที่ แผนเที่ยวออกแบบเพื่อคุณจริงๆ',
...
const testimonials = [
  {
    ...
    quote: 'ทริปญี่ปุ่นฤดูหนาวคือที่สุด ทุกคนสนุกเพราะทีม Gography ปรับทุกอย่างให้เข้ากับเด็กและผู้ใหญ่ได้ลงตัว',
    image: '/private/customer1.webp',
  },
  {
    name: 'คุณอิง + แก๊งเพื่อน',
    quote: 'ประทับใจมาก ได้เที่ยวสไตล์ที่ชอบและได้รูปสวยๆ กลับมาด้วย แค่มากับเพื่อนแล้วที่เหลือทีมงานจัดให้หมด',
    image: '/private/customer2.webp',
  },
  {
    name: 'บริษัทสตาร์ทอัป',
    quote: 'ทริปทีมบิลดิ้งที่ไอซ์แลนด์ทำให้ทุกคนใกล้ชิดกันขึ้น บริการดูแลแบบใส่ใจและยืดหยุ่นตามสถานการณ์จริง',
    image: '/private/customer3.webp',
  },
  {
    name: 'คู่รักสายโรแมนติก',
    quote: 'การขอแต่งงานริมทะเลสาบสวิสคือที่สุด ทีมงานเตรียมให้ทุกอย่างสมบูรณ์แบบมาก',
          ...
          <div className="relative z-10 w-full">
            <div className="container mx-auto px-6 py-24 text-center text-white max-w-4xl">
              ...
              <p className="text-base md:text-lg mb-10">
                เที่ยวกับ GOGRAPHY อย่างสบายใจ ไม่ต้องวางแผนเอง ปรึกษาเราแล้วให้ทีมมืออาชีพออกแบบทริปที่ใช่ที่สุดสำหรับคุณ
              </p>
              <Link
                href="/contact"
